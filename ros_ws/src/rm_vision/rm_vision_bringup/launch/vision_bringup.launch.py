...
def generate_launch_description():
    ...
    from common import node_params, launch_params, robot_state_publisher, armor_tracker_node, buff_tracker_node, fire_control_node
    ...
    delay_fire_control_node = TimerAction(
        period=2.5,
